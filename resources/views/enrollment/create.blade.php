    ...
    <div class="card">
        <div class="card-content">
            ...
            <div class="row">
                ...
                <div class="input-field col s6">
                    <input  id="name" name="name" placeholder="Ingrese aqui el nombre " type="text" class="validate" readonly>
                    <label for="first_name">Nombre</label>
                </div>
                <div class="input-field col s6">
                    <input  id="lastName" name="lastName" placeholder="Ingrese aqui los apellidos " type="text" class="validate" readonly>
            ...
            <div class="card">
                <div class="card-content">
                    ...
                    <div class="input-field">
                        ...
                        <div class="input-field">
                            <input  id="uniform" name="uniform" placeholder="Pago por uniforme" type="number" required>
